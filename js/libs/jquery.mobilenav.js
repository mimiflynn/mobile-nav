...
//				var o = options;
        ...
        function addHeader(el) { //construct header that appears over regular header
        ...
        function action(el){ //when nav item with subnav is clicked
        ...
        function init(el) {
          ...
          $('.mobile-nav a.has-subnav').hover(function(){ //when nav item with subnav is clicked
